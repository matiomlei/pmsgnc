	...
	<body>
		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header" id="page-header">	
							...
							<div class="col-md-4">
								<div id="funcButtons">
					                  <div id="zhiliangjianchaButtonList" style="display:none">
					                      <button type="button" class="btn btn-purple btn-sm" onclick="queryQualityTaskByDeploymentId()">查看详情</button>
					                      <a href="#" class="btn btn-purple btn-sm" id='zhijianfentuModal' onClick="fentuzuoyePrepare()">质检分图</a>
					                      <a href="#" class="btn btn-purple btn-sm" id="zhiLiangJianChaModal">质检上传</a>
					                  </div>
					                  <div id="zhiliangjianchaButtonList2" style="display:none">
					                  </div>
					            </div>
							</div>				
						</div>
					              ...
					              <div class="tabbable" id="tabs-466212">
					                  <ul id="navTabs" class="nav nav-tabs">
					                      ...
					                      <li>
					                          ...
					                          <div style="display:none;">
                    							  <div id="popup" title="各市(州)商品房销售情况（2013年）"></div>
                							  </div>
					                      </li>
					                  </ul>
			    ...
			    <div id="deleteDeploymentModalContent" class="hide">
			    	<p class="bg-danger">确定删除该条任务？</p>
			    </div>
